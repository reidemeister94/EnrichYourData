...
class NewsPostProcess:
    def __init__(self):
        ...
        self.parent_dir = os.path.dirname(current_file_dir)
        with open(self.parent_dir + "/dataprocessing/configuration/configuration.yaml") as f:
    ...
    def __get_logger(self):
        ...
        log_path = self.parent_dir + "/dataprocessing/log/news_post_process.log"
        if not os.path.isdir(self.parent_dir + "/dataprocessing/log/"):
            os.mkdir(self.parent_dir + "/dataprocessing/log/")
